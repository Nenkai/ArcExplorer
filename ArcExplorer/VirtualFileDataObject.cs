...
/// </summary>
public sealed partial class VirtualFileDataObject : IDataObject, IAsyncOperation
{
    /// <summary>
    ...
    private static readonly short FILECONTENTS = (short)NativeMethods.RegisterClipboardFormat(NativeMethods.CFSTR_FILECONTENTS);
    private static readonly short FILEDESCRIPTORW = (short)NativeMethods.RegisterClipboardFormat(NativeMethods.CFSTR_FILEDESCRIPTORW);
    private static readonly short PASTESUCCEEDED = (short)NativeMethods.RegisterClipboardFormat(NativeMethods.CFSTR_PASTESUCCEEDED);
    private static readonly short PERFORMEDDROPEFFECT = (short)NativeMethods.RegisterClipboardFormat(NativeMethods.CFSTR_PERFORMEDDROPEFFECT);
    private static readonly short PREFERREDDROPEFFECT = (short)NativeMethods.RegisterClipboardFormat(NativeMethods.CFSTR_PREFERREDDROPEFFECT);
    ...
    /// </remarks>
    public void SetData(short dataFormat, int index, FileDescriptor fileDescriptor, Action<FileDescriptor, Stream> streamData)
    {
        _dataObjects.Add(
            new DataObject
            {
    ...
    private static byte[] StructureBytes<T>(T source)
    {
        ...
        try
        {
            Marshal.StructureToPtr<T>(source, ptr, false);
    ...
    private class DataObject
    {
        ...
        /// </summary>
        public Func<(nint, int)> GetData { get; set; }
    }
